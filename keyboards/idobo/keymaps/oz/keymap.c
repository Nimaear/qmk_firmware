...
// Keyboard Layers
#define _COLEMAK 0
#define _COLEMAK_MAC 1
#define _LOWER 2
#define _RAISE 3
#define _FNLYR 4

#define CLMK TO(_COLEMAK)
#define CLMK_MAC TO(_COLEMAK_MAC)
...
[_COLEMAK] = LAYOUT_ortho_5x15(
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_MINS,  KC_F2,  KC_EQL,   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC, \
    KC_GRV,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,    KC_LPRN,  KC_F5,  KC_RPRN,  KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_DEL,
    KC_TAB,  KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_LCBR,  KC_F8,  KC_RCBR,  KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC,  KC_F11, KC_RBRC,  KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
    KC_LCTL, KC_LGUI, KC_LALT, FNLYR,   LOWER,   KC_SPC,  KC_MINS,  KC_F14, KC_PLUS,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),

[_COLEMAK_MAC] = LAYOUT_ortho_5x15(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______,
    KC_LGUI, KC_LCTL, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______
),
...
[_LOWER] = LAYOUT_ortho_5x15(
    ...
    _______, _______, _______, _______, _______, KC_MINS, _______, _______, _______, KC_PLUS, _______,  _______, _______, _______, _______,
...
[_FNLYR] = LAYOUT_ortho_5x15(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______,
    RESET,   _______, _______, _______, _______, _______, CLMK,   CLMK_MAC, _______, _______, _______, KC_MNXT,  KC_VOLD, KC_VOLU, KC_MPLY
)
